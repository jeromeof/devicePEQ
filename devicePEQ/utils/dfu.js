var dfu = {}
   ...
   * WebDFU library.
   *
   * This code is primarily taken from:
   *
...
;(function () {
  ...
  dfu.RESET_INTO_DFU = 0xf2
  dfu.RESET_FROM_DFU = 0xf3
  ...
  dfu.Device.prototype.startUpdate = function () {
    return this.requestOut(dfu.RESET_INTO_DFU, undefined, 0)
  }

  dfu.Device.prototype.finishUpgrade = function () {
    return this.requestOut(dfu.RESET_FROM_DFU, undefined, 0)
  }
})()
